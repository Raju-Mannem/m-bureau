          ...
          <div className="flex flex-wrap items-center md:justify-between justify-center">
            <div className="w-full md:w-4/12 px-4 mx-auto text-center">
              <div className="text-sm text-blueGray-500 font-semibold py-1">
                ...
                <motion.a href="https://www.creative-tim.com/product/notus-js" className="text-blueGray-500 hover:text-gray-800" target="_blank" {...itemAnimation} transition={{ duration: 1.5, delay: 0.2 }}> Notus JS by</motion.a>
                <motion.a href="https://www.creative-tim.com?ref=njs-profile" className="text-blueGray-500 hover:text-blueGray-800" {...itemAnimation} transition={{ duration: 1.5, delay: 0.3 }}>Creative Tim</motion.a>.
              </div>
            </div>
          </div>
        </div>
