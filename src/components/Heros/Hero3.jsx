...
function Hero3() {
  ...
  return (
    <div ref={ref}>
      ...
      >
        <div
          className="mx-auto mb-20 max-w-screen-xl px-4 py-32 sm:px-6 sm:py-12 lg:px-8 lg:py-8 shadow-2xl shadow-yellow-950 rounded-lg border-r-4 border-b-4 border-green-400
        bg-white
        "
        >
          <div className="grid sm:grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 lg:py-8">
            ...
            <div className="lg:py-24 sm:px-12">
              ...
              <p className="mt-4 text-gray-600 font-bold text-left leading-9">
                మీకు సరైన వ్యక్తిని కనుగొనడంలో, మేము మీకు సహాయపడతాము. మా
                విశేషమైన సేవలతో, మీ జీవితంలో ప్రేమను మరియు సంతోషాన్ని అందించడం
                మాకు ముఖ్యమైనది.
              </p>
            </div>
          </div>
