...
function Stats() {
  ...
  return (
    <div ref={ref}>
      ...
      >
        <div class="max-w-screen-2xl px-4 py-24 
        ...
        bg-cover
         sm:px-6 sm:py-12 lg:px-8">
          <div class="mx-auto max-w-3xl text-center bg-white mb-32">
            <h2 class="text-3xl font-bold text-green-400 py-2 sm:text-2xl bg-white rounded-t-lg underline decoration-4">
            మీ కలలు నిజం చేయడానికి ఇక్కడ ఉన్నాము
            </h2>

            <p class="mt-4 text-green-400 sm:text-xl">
          ...
          <dl class="mg-6 grid lg:grid-cols-4 gap-4 divide-y divide-gray-100 sm:mt-8 sm:grid-cols-2 sm:divide-x sm:divide-y-0">
            <div class="flex flex-col px-4 py-8 text-center bg-white rounded-lg border-none">
