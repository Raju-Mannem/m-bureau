...
export const Menu = ({ setActive, children }) => {
  return (
    <nav
      style={{backgroundImage: 'url(https://res.cloudinary.com/dhxtw97su/image/upload/f_auto,q_auto/v1/marriage-bureau/sdgbrc5o5fbdddco3vux), linear-gradient(120deg, #fdfbfb 0%, #ebedee 100%)',
