...
export const Menu = ({ setActive, children }) => {
  return (
    <nav
      style={{backgroundImage: 'url(/src/assets/top-image.png), linear-gradient(120deg, #fdfbfb 0%, #ebedee 100%)',backgroundRepeat: 'no-repeat', backgroundSize: 'contain', backgroundPosition: 'center -3%', boxShadow: '0 20px 30px -10px rgba(0, 0, 0, 0.3)'}}
